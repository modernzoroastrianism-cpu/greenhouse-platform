          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-6">
              <div className="bg-greenhouse-50 rounded-lg p-4 text-center">
                ...
                <div className="text-sm text-gray-600">For yourself and your family</div>
              </div>
              <div className="bg-greenhouse-50 rounded-lg p-4 text-center">
                <div className="text-2xl mb-2">🤝</div>
                <div className="font-semibold text-gray-900">Share Abundance</div>
                <div className="text-sm text-gray-600">Excess goes to those in need</div>
              </div>
              <div className="bg-greenhouse-50 rounded-lg p-4 text-center">
                <div className="text-2xl mb-2">🤖</div>
                <div className="font-semibold text-gray-900">Trust AI</div>
                <div className="text-sm text-gray-600">Proof that AI can help, not harm</div>
              </div>
            </div>
          </div>
        </section>
